  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res)
	  ...
	  req.setCharacterEncoding("UTF-8");
	    ...
	    if (!allowUser(merchant_id, merchant_pass)) {          //【帳號 , 密碼無效時】
	      ...
	      out.println("請按此重新登入 <A HREF="+req.getContextPath()+"/VIEW/MerchantLogin.jsp>重新登入</A>");
		...
		MerchantVO merchantVO = merchantSvc.getOneMerchantId(merchant_id);
	      ...
	      res.sendRedirect(req.getContextPath()+"/VIEW/merchantindex.jsp");  //*工作3: (-->如無來源網頁:則重導至login_success.jsp)
	    }
	  }
	}