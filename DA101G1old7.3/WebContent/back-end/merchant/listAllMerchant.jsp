...
<aside id="aside">
	<h1>ASIDE 左側邊</h1>
	<div>
		<a href="<%=request.getContextPath()%>/back-end/merchant/merchant_select_page.jsp">廠商資料管理<br></a> 
...
<table>
	...
	<c:forEach var="merchantVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		...
		<tr>
			...
			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Back_endMerchantServlet1" style="margin-bottom: 0px;">
