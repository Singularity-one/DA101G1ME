...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath()%>/back-end/promotion/promotion_select_page.jsp"><img src="<%=request.getContextPath()%>/back-end/promotion/images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	...
	<tr>
		<td>廣告結束日期:</td>
		<td><input name="promotion_end" id="f_date1" type="date"></td>
	</tr>
	<tr>
		<td>商品促銷折扣:</td>
