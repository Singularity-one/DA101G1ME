...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath()%>/front-end/promotion/promotion_select_page.jsp"><img src="<%=request.getContextPath()%>/front-end/promotion/images/back1.gif" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	...
	<c:forEach var="promotionVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		...
		<tr>
			...
			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Front_endPromotionServlet1" style="margin-bottom: 0px;">
