...
<title>廣告資料新增 - addpromotion.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>儲值資料新增 - addPromotion.jsp</h3></td><td>
		 <h4><a href="<%=request.getContextPath()%>/front-end/promotion/promotion_select_page.jsp"><img src="<%=request.getContextPath()%>/front-end/promotion/images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="merchant_no" size="45" 
			 value="<%= (promotionVO==null)? "ME00001" : promotionVO.getMerchant_no()%>" /></td>
	</tr>
	<tr>
		<td>商品編號:</td>
	...
	<tr>
		<td>廣告狀態:</td>
		<td><input type="TEXT" name="promotion_status" size="45" 
			 value="<%= (promotionVO==null)? "B2" : promotionVO.getPromotion_status()%>" /></td>
	</tr>
	<tr>
		<td>廣告圖片:</td>
		<td>
		<input type="file" id="promotion_input" accept="image/gif, image/jpeg, image/png" name="promotion_img">
	    </td>
	</tr>
