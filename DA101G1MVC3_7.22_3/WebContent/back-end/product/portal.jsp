...
<div class="portal">
<div class="logo">
<img src="<%=request.getContextPath()%>/back-end/product/icon.jpeg" id="logo">

<ul class="list-group list-group-flush ">
  <li class="list-group-item"><a href='<%=request.getContextPath()%>/back-end/product/portal.jsp'>查詢</a></li>
  <li class="list-group-item"><a href='<%=request.getContextPath()%>/back-end/product/Product.jsp'>全部</a></li>
