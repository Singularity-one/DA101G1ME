...
　				<option value="O2">已出貨</option>
       ...
       <b>選擇日期:</b><br>
                    開始日期:<input name="order_time_start" id="f_date3" type="date"><br>
		結束日期:<input name="order_time_end" id="f_date4" type="date"><br>
		<b>選擇金額:</b><br>
		大於多少<input type="TEXT" name="order_amosum_start" size="45"  value="" /><br>
		小於多少<input type="TEXT" name="order_amosum_end" size="45"  value="" /><br>
		
		<b>輸入廠商編號 (如ME00001):</b>
        <input type="text" name="merchant_no" value=""><br>
