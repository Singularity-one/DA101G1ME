			...
			<div class="col-5 right"">
				...
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/MerchantServlet1" name="form1"  enctype="multipart/form-data">
					...
					<tr>
						<td>廠商說明:</td>
						<td>
<%-- 					<input type="TEXT" name="merchant_ps" size="45" value="<%=merchantVO.getMerchant_ps()%>" /> --%>
    					<textarea  name="merchant_ps" style="width:400px;height:120px;"><%=merchantVO.getMerchant_ps()%></textarea>
						</td>
